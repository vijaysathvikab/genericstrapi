...
export interface ApiFooterConfigFooterConfig extends Schema.SingleType {
...
export interface ApiHeaderConfigHeaderConfig extends Schema.SingleType {
  collectionName: 'header_configs';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::header-config.header-config': ApiHeaderConfigHeaderConfig;
